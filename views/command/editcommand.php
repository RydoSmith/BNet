<div class="static-content">
    <div class="page-content">
        <ol class="breadcrumb">
            ...
            <li><a href="#">Edit Command</a></li>
        </ol>
        <div class="container-fluid">
            <h1 class="mt0">Edit Command</h1>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-bluegray" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
                            <form class="form-horizontal" action="/command/editcommand" method="post">
                            <div class="panel-heading">
                                <h2>Edit an existing command</h2>
                            </div>
